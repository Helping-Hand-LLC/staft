...
export default function EditEvent({ oldTitle, oldLocation, oldLinks }) {
...
EditEvent.propTypes = {
  ...
  oldLocation: PropTypes.shape({
    id: PropTypes.number.isRequired,
    name: PropTypes.string.isRequired,
    formatted_address: PropTypes.string.isRequired,
    place_id: PropTypes.string.isRequired
  }),
  oldLinks: PropTypes.arrayOf(PropTypes.string)
};
EventLink.propTypes = {
  name: PropTypes.string.isRequired,
