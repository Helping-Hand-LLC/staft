...
function Light() {
  return (
    <div class='w-64 h-screen bg-white'>
      ...
      <nav class='mt-10'>
        <a
          class='flex items-center py-2 px-8 block bg-gray-200 text-gray-700 border-r-4 border-gray-700'
          href='#'
        >
          <svg
            class='h-5 w-5'
        ...
        <a
          class='flex items-center mt-5 py-2 px-8 block text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700'
          href='#'
        >
          <svg
            class='h-5 w-5'
      ...
      <div class='absolute bottom-0 my-10'>
        <a
          class='flex items-center py-2 px-8 block text-gray-500 hover:text-gray-600'
          href='#'
        >
          <svg
            class='h-5 w-5'
...
function Dark() {
  return (
    <div class='w-64 h-screen bg-gray-800 mt-8 sm:mt-0'>
      ...
      <nav class='mt-10'>
        <a
          class='flex items-center py-2 px-8 block bg-gray-700 text-gray-100 border-r-4 border-gray-100'
          href='#'
        >
          <svg
            class='h-5 w-5'
        ...
        <a
          class='flex items-center mt-5 py-2 px-8 block text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100'
          href='#'
        >
          <svg
            class='h-5 w-5'
      ...
      <div class='absolute bottom-0 my-10'>
        <a
          class='flex items-center py-2 px-8 block text-gray-600 hover:text-gray-500'
          href='#'
        >
          <svg
            class='h-5 w-5'
